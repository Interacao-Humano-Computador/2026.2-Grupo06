...
| :---: | --- | :---: | --- |
| 1 | Histórico de versão padronizado? | Sim (padrão publicado) | Todos, ao preencher |
| 2 | Autor(es) e revisor(es) em cada artefato? | Incompleto | Autor de cada página |
| 3 | Referências bibliográficas em todos os artefatos? | Incompleto | Autor de cada página |
| 4 | Tabelas e imagens com legenda, fonte e chamada no texto? | Sim no padrão; conferir o conteúdo | Todos |
| 5 | Texto de introdução dos artefatos? | Sim nos modelos | Todos |
| 6 | Cronograma executado com quem fez o quê e as datas reais? | Incompleto | Luis Henrique |
