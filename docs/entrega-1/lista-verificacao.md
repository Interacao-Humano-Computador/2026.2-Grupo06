...
Use esta página no ensaio da apresentação e na inspeção interna. As perguntas vêm da lista sugerida no plano de ensino.
...
| 2 | Cronograma com todas as atividades, todas as etapas, início, fim e período de revisão? | Sim | Luis Henrique | [Cronograma](cronograma.md) |
| 3 | Período de gravação da apresentação de cada etapa? | Sim | Luis Henrique | [Cronograma](cronograma.md) |
| 4 | Período de revisão/ajuste após monitores e professor? | Sim | Luis Henrique | [Cronograma](cronograma.md) |
