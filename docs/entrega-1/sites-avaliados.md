<span class="owner">Responsável: Israel Soares de Paiva — Pesquisa e seleção do site</span>
...
| Integrante | Site | Endereço |
| --- | --- | --- |
| Heitor Pinheiro | Portal da Transparência do DF | https://www.transparencia.df.gov.br/ |
| Israel Soares | A definir | URL |
| Luis Henrique | A definir | URL |
| Bruno Ferreira | A definir | URL |
...
Use os mesmos critérios em todos os sites. Troque peso e enunciado se o grupo decidir outros.

| Código | Critério | O que observar | Peso |
| --- | --- | --- | :---: |
| C1 | Relevância pública | Cidadãos usam o serviço no dia a dia | A definir |
| C2 | Escopo no semestre | Dá para delimitar tarefas reais | A definir |
| C3 | Problemas de IHC | Há falhas de uso ou de acessibilidade | A definir |
| C4 | Acesso | O site é público e está no ar | A definir |
| C5 | Adequação à disciplina | Cabe processo de design, ética e protótipo | A definir |

<p class="caption">Tabela 2 — Critérios aplicados a todos os candidatos.</p>
<p class="source">Fonte: elaboração do Grupo 06 (2026).</p>

## Pontuação

| Site | C1 | C2 | C3 | C4 | C5 | Total |
| --- | :---: | :---: | :---: | :---: | :---: | :---: |
| Portal da Transparência do DF |  |  |  |  |  |  |
| Site 2 |  |  |  |  |  |  |
| Site 3 |  |  |  |  |  |  |

<p class="caption">Tabela 3 — Pontuação comparativa.</p>
<p class="source">Fonte: elaboração do Grupo 06 (2026).</p>

A comparação da Tabela 3 deve aparecer no texto: “A pontuação da Tabela 3 mostra que…”.
...
3. A dor principal em uma frase.
4. Se o site segue ou não como candidato, e por quê.

## Portal da Transparência do DF

Heitor Pinheiro já fez avaliação individual deste site. Israel resume o que o grupo aproveita, chama a Tabela 3 e decide se o Portal permanece como escolha. Não copie o relatório do Heitor inteiro.

## Site 2

Nome, endereço, responsável pela inspeção e o bloco da seção anterior.
...
Uma captura da página inicial de cada candidato, com legenda e fonte, no formato da [página de figuras](../guia/figuras-tabelas-referencias.md).
