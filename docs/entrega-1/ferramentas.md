...
| --- | --- | --- | --- |
| GitHub | Versionamento e histórico identificável | Todas as etapas | Todos |
| GitHub Pages / MkDocs | Publicação dos artefatos | Todas as etapas | Caio Breno e autores |
| Microsoft Teams | Reuniões oficiais da disciplina | Todas as etapas | Bruno Ferreira |
| WhatsApp | Combinados rápidos do grupo | Todas as etapas | Todos |
| YouTube (não listado) | Vídeos de reunião e de apresentação | Todas as etapas | Bruno Ferreira |
| Moodle / Aprender3 | Entrega formal de cada etapa | Todas as etapas | Todos |
| VS Code ou editor equivalente | Redação dos artefatos | Todas as etapas | Todos |
| Navegador com DevTools | Inspeção do site avaliado | Etapas 1 a 8 | Autores da avaliação |
| ASES e WAVE | Apoio a acessibilidade | Etapas 1, 3 e 8 | Quem for avaliar conformidade |
| Figma ou similar | Protótipo de alta fidelidade | Etapas 6 e 7 | A definir |
| Papel, caneta e celular | Protótipo de baixa fidelidade e evidências | Etapas 4 e 5 | A definir |
