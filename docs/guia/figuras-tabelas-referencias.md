...
<figure markdown="span">
  ...
  <figcaption>Figura 1 — Página inicial do Portal da Transparência do DF.</figcaption>
</figure>
<p class="source">Fonte: DISTRITO FEDERAL (2026).</p>
```
...
[2] DISTRITO FEDERAL. Portal da Transparência do Distrito Federal. Disponível em: https://www.transparencia.df.gov.br/. Acesso em: 4 set. 2026.
