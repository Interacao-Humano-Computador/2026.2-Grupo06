<span class="owner">Responsável: Caio Breno de Souza Bezerra — Elaboração dos cenários · Autor do item: Caio Breno de Souza Bezerra</span>
...
<p class="caption">Tabela 2 — Elementos do cenário e o que a narrativa deve responder.</p>
<p class="source">Fonte: elaboração do Grupo 06 (2026), adaptado de BARBOSA; SILVA (2010, p. 187–188).</p>
...
??? note "Figura 1 — Definição e elementos de um cenário"
    ...
    <figure markdown="span">
      ![Trecho do livro Interação Humano-Computador, seção 6.3 Cenários, com a definição de cenário e a lista dos elementos característicos: ambiente ou contexto, atores, objetivos, planejamento, ações, eventos e avaliação.](../assets/img/referencias/cenarios-barbosa-silva-p183-184.png)
      <figcaption>Figura 1 — Definição e elementos de um cenário.</figcaption>
    </figure>
    <p class="source">Fonte: BARBOSA; SILVA (2010, p. 183–184).</p>
