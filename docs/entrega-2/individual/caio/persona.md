<span class="owner">Responsável: Caio Breno de Souza Bezerra — Persona</span>
...
<p class="source">Fonte: retrato gerado para esta persona (2026). Não é a participante.</p>
...
Os objetivos não são as tarefas. A tarefa muda com o portal; o objetivo permanece (BARBOSA; SILVA, 2010, p. 181). A separação abaixo é a do Exemplo 6.3 (p. 182–183).

Objetivos pessoais:

- não perder tempo separando notícia antiga no meio da recente;
- não publicar nada que a equipe ainda não tenha aprovado;
- achar logo o caminho do portal, sem atravessar assuntos que não são do anuário.

Objetivos práticos:

- reunir, no período do anuário, notícias e normas da área espacial e das forças armadas;
- buscar por palavra-chave e ler o resultado do mais novo ao mais antigo;
- salvar a notícia para a análise da equipe;
- encerrar ou mudar de site quando o período não tem notícia relevante.
...
| Status | A definir no [elenco](../../elenco-personas.md), quando as cinco personas existirem. Uso de trabalho, recorrente, não consulta pontual | Sessão, sintetizada |
...
| Tarefas | Em linhas gerais: levantar notícias e normas do setor no período do anuário, descartar o que é antigo e encaminhar o que segue para aprovação. O detalhe de uma busca está no cenário | Sessão, sintetizada |
| Relacionamentos | Outros estagiários; quem aprova a notícia no órgão; leitores do anuário | Sessão, sintetizada |
| Requisitos | Atalho até o que precisa; resultados em ordem de data e de tema; um jeito de saber que o período acabou; guardar a notícia sem publicá-la ainda | Sessão, sintetizada |
...
<p class="caption">Tabela 2 — Elementos da persona.</p>
<p class="source">Fonte: elaboração do Grupo 06 (2026), com base em BARBOSA; SILVA (2010, p. 177) e na sessão de 24/09/2026.</p>
...
Categoria no YouTube: **não listado**. Link: [https://youtu.be/-_NGav1nuwM](https://youtu.be/-_NGav1nuwM). Data: 24/09/2026. A legenda com o nome da participante foi coberta.
...
<p class="caption">Vídeo 1 — Validação da persona com a participante.</p>
...
<p class="caption">Tabela 3 — Registro da validação da persona.</p>
<p class="source">Fonte: elaboração do Grupo 06 (2026), a partir da validação de 24/09/2026.</p>

## Agradecimentos

Esta página contou com o apoio de ferramenta de inteligência artificial generativa na estruturação, na redação preliminar, na transcrição das gravações e na formatação Markdown. A revisão do conteúdo, a coleta e a validação com a participante são do autor, que segue responsável pelo que está publicado.
